...
function diff(string1, string2){
  return diff2(string1, string1.length, 0, string2, string2.length, 0);
}
...
let string1 = "abcf";
let string2 = "abdehgz";
console.log(middleSnake(string1, string2))
console.log(`comparing "${string1}" and "${string2}"`);
let [difference, editGraph] = diff(string1, string2);
console.log(editGraph);
let simpleEdits = concatEditGraph(editGraph);
console.log(concatEditGraph(editGraph));
...
console.log(prettyPrintString(string1,simpleEdits["delete"], "delete"));
console.log(prettyPrintString(string2,simpleEdits["insert"], "insert"));
