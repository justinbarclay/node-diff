...
function forward({first,
      ...
      let xStart = x;
      let yStart = y;
      while (x < N && y < M && first[x+1] === second[y+1]){
        x++;
        y++;
      }
...
function middleSnake(first, second){
  ...
  for(let d=0; d <= Math.ceil(MAX/2); d++){
    ...
    for(let k=-d; k <= d; k=k+2){
      let [[xStart, yStart], [x, y]] = forward({first: first,
                                                second: second,
                                                d: d,
                                                k: k,
                                                delta: delta,
    ...
    for(let k = -d + delta; k <= d + delta; k=k+2){
      ...
      var [[x, y], [xStart,yStart]] = backward({first: first,
                                                second: second,
                                                d: d,
                                                k:k ,
                                                delta: delta,
...
//////////////////////////////////
//
// Forward and Backward functions with lots of logging
//
/////////////////////////////////

function forward_debug({first,
                        second,
                        d,
                        k,
                        delta,
...
function backward_debug({first,
  ...
  console.log("let up = (k === d + delta || (k !== -d + delta && reverseV[MAX + k - 1 - delta] < reverseV[MAX + k + 1 - delta]));");
