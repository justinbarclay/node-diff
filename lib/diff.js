...
// Returns the count of the differences between two strings and an edit graph
// of deletions and insertions that it would take to transform string1 into
// string2
function diffGreedy(first, second){
